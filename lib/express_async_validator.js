(function (module, require) {
    ...
    var validators = {
        ...
        "float":        require('./validators/float'),
        "email":        require('./validators/email'),
        "url":          require('./validators/url'),
        "ip":           require('./validators/ip'),
        "alpha":        require('./validators/alpha'),
        "alphanumeric": require('./validators/alphanumeric'),
        "numeric":      require('./validators/numeric'),
        "hexadecimal":  require('./validators/hexadecimal'),
        "hexColor":     require('./validators/hex_color'),
        "lowercase":    require('./validators/lowercase'),
        "uppercase":    require('./validators/uppercase'),
        "divisibleBy":  require('./validators/divisible_by')
    };
